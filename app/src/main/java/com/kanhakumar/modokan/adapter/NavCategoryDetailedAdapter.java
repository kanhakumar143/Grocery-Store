...
public class NavCategoryDetailedAdapter extends RecyclerView.Adapter<NavCategoryDetailedAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.cat_detailed_img);
            price = itemView.findViewById(R.id.nav_detailed_price);
            name = itemView.findViewById(R.id.nav_detailed_name);
